            ...
            <div className={`rounded-2xl ${timeOfDay == 'd' ? 'bg-sky-400' : 'bg-sky-950'} opacity-90`}>
                <div className="p-3 grid grid-cols-4">
                    <input 
                        ...
                        id="small-input" 
                        className="col-span-3 block p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-blue-500 focus:border-blue-500" 
                    />
                    <button type="submit" onClick={handleSubmit} className="bg-opacity-70 hover:bg-opacity-50 text-white col-span-1 bg-indigo-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm ms-1">
